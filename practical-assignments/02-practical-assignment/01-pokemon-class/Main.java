...
class Pokemon {
    ...
    /**
     * Cria um clone do objeto Pokemon fornecido.
     *
     * @param pokemon o objeto Pokemon a ser clonado
     * @return uma nova instância de Pokemon com os mesmos atributos
     */
...
/**
 * A classe Main é responsável por interagir com o usuário, recebendo uma lista de IDs de Pokémons,
 * lendo os dados correspondentes a partir de um arquivo CSV e exibindo as informações dos Pokémons.
 */
public class Main {
