...
class Pokemon {
     ...
     * e utilizá-lo na pesquisa por nome.
     *
...
/**
 * A classe `PartialSelectionSort` é responsável por interagir com o usuário, recebendo uma lista de IDs de Pokémons,
 * lendo os dados correspondentes a partir de um arquivo CSV e realizando a ordenação parcial dos primeiros k Pokémons
 * pelo nome, utilizando o algoritmo de ordenação por seleção. Após a ordenação parcial, as informações dos primeiros
 * k Pokémons ordenados são exibidas, enquanto o restante da lista permanece inalterado.
 */
