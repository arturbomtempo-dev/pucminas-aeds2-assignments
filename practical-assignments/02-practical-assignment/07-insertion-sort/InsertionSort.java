...
class Pokemon {
     ...
     * e utilizá-lo como critério de desempate na ordenação por inserção
     * com base na data de captura.
     *
    ...
    /**
     * Retorna a data de captura do Pokémon. Necessário para acessar o valor privado
     * e utilizá-lo na ordenação por data de captura.
     *
...
/**
 * A classe `InsertionSort` é responsável por interagir com o usuário, recebendo uma lista de IDs de Pokémons,
 * lendo os dados correspondentes a partir de um arquivo CSV, ordenando os Pokémons pela data de captura (e pelo nome em caso de empate)
 * utilizando o algoritmo de ordenação por inserção, e exibindo as informações dos Pokémons ordenados.
 */
